                    ...
                    <div>
                        <div class="container" style="position: relative; z-index: 1;">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="card1">
                                        <form method="POST" action="{{ route('addProject') }}"class="box" enctype="multipart/form-data" style="width: 500px; padding: 40px;position: absolute;top: 50%;left: 50%; background: #191919;text-align: center;transition: 0.25s; margin-top: 100px; border-radius: 20px; box-shadow: -1px 4px 14px 7px rgb(0 0 0 / 40%)">
                                            @csrf
                                            <h4>Add Project</h4>
                                            ...
                                            @error("category")
                                                <p class="text-danger">{{ $message}}</p>
                                            @enderror
                                            <input type="submit" name="" href="{{ route('account',['user']) }}" value="Add project" href="#">
                                        </form>
                                    </div>
                                </div>
                            </div>
